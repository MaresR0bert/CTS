...
public class BankAccountTest {
    ...
    public void testCardinality() {
        float result = bankAccount.getBalance();
        assertEquals("Balance is not correct", 0, result, 0.01f);
    }
    ...
    public void testCardinality2() throws InsufficentFunds {
        bankAccount.addTransaction(100f);
        float result = bankAccount.getBalance();
        assertEquals("Balance is not correct", 100, result, 0.01f);
    }
    ...
    public void testInverse() throws InsufficentFunds {
        ...
        float result = bankAccount.getBalance();
        var newTrans = bankAccount.getTransactions();

        Collections.reverse(newTrans);
        for(var newTran : newTrans){
            result -= newTran;
        }
    ...
    public void testCrossCheck() throws InsufficentFunds {
        ...
        assertEquals("Balance incorrect",expected,result,0.001f);
    }
